...
<div className="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div id="fullWidthTabContent" className="border-t border-gray-200 dark:border-gray-600">
        <h1 className='text-center text-2xl my-6 font-semibold'>Statistics</h1>
        ...
        <div className=" p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="about" role="tabpanel" aria-labelledby="about-tab">
            <h2 className='text-center text-2xl my-6 font-semibold'>Services</h2>
            {/* <!-- List --> */}
        ...
        <h2 className='text-center text-2xl my-6 font-semibold'>Frequently Asked Questions</h2>
