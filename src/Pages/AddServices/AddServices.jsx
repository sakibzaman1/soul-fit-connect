...
const AddServices = () => {
    ...
    const handleAddService = (e) => {
        ...
        const newService = {serviceName, serviceImage, price, proName, proImage, proEmail,providerLocation, serviceArea, description};
      ...
      <form onSubmit={handleAddService}>
          <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
              ...
              <div className="w-full">
                  ...
                  <input type="text" name="serviceArea" id="" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Service Area" required=""/>
              </div>
              <div className="sm:col-span-2">
                  <label for="brand" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Provider Location</label>
                  <input type="text" name="providerLocation" id="" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Provider Location" required=""/>
              </div>
              <div className="sm:col-span-2">
